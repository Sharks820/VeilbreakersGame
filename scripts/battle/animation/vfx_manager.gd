...
const BRAND_COLORS = {
	"SAVAGE":
	{"primary": Color("c73e3e"), "secondary": Color("ff6b6b"), "particle": Color("8b0000")},
	"IRON": {"primary": Color("7b8794"), "secondary": Color("a8b5c4"), "particle": Color("4a5568")},
	"VENOM":
	{"primary": Color("6b9b37"), "secondary": Color("9acd32"), "particle": Color("2d4a0f")},
	"SURGE":
	{"primary": Color("4a90d9"), "secondary": Color("87ceeb"), "particle": Color("1e3a5f")},
	"DREAD":
	{"primary": Color("5d3e8c"), "secondary": Color("9370db"), "particle": Color("2d1f4a")},
	"LEECH":
	{"primary": Color("c75b8a"), "secondary": Color("ff91af"), "particle": Color("8b2252")},
...
func _get_status_apply_scene(status: String) -> PackedScene:
	match status.to_lower():
		"poison", "poisoned":
			return status_apply_poison
		"burn", "burning":
			return status_apply_burn
		"stun", "stunned":
			return status_apply_stun
		"buff":
			return status_apply_buff
		"debuff":
			return status_apply_debuff
		_:
			return status_apply_poison
