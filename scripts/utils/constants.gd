...
const PATH_BRAND_WEAKNESS: Dictionary = {
	"IRONBOUND": "VENOM", "FANGBORN": "IRON", "VOIDTOUCHED": "DREAD", "UNCHAINED": "LEECH"  # Steel corroded by acid  # Fangs can't pierce steel  # Void fears the abyss  # Draining binds the free
}

# Path-Brand Strength (Heroes are strong against these brands)
const PATH_BRAND_STRENGTH: Dictionary = {
	"IRONBOUND": "SAVAGE", "FANGBORN": "LEECH", "VOIDTOUCHED": "SURGE", "UNCHAINED": "DREAD"  # Steel stops brutes  # Fangs drain life  # Void absorbs energy  # Freedom conquers fear
}
...
const BRAND_BONUSES: Dictionary = {
	...
	"SAVAGE": {"atk_mult": 1.25},  # +25% ATK - Raw destruction
	"IRON": {"hp_mult": 1.30},  # +30% HP - Unyielding defense
	"VENOM": {"crit_mult": 1.20, "status_mult": 1.15},  # +20% Crit chance  # +15% Status proc chance
	"SURGE": {"spd_mult": 1.25},  # +25% SPD - Lightning speed
	"DREAD": {"eva_mult": 1.20, "fear_mult": 1.15},  # +20% Evasion  # +15% Fear proc chance
	"LEECH": {"lifesteal_mult": 1.20},  # +20% Lifesteal
	# === HYBRID BRANDS (6) - 70% Primary + 30% Secondary ===
	"BLOODIRON": {"atk_mult": 1.175, "hp_mult": 1.09},  # 70% of SAVAGE (+17.5% ATK)  # 30% of IRON (+9% HP)
	"CORROSIVE": {"hp_mult": 1.21, "crit_mult": 1.06, "status_mult": 1.045},  # 70% of IRON (+21% HP)  # 30% of VENOM (+6% Crit)  # 30% of VENOM (+4.5% Status)
	"VENOMSTRIKE": {"crit_mult": 1.14, "status_mult": 1.105, "spd_mult": 1.075},  # 70% of VENOM (+14% Crit)  # 70% of VENOM (+10.5% Status)  # 30% of SURGE (+7.5% SPD)
	"TERRORFLUX": {"spd_mult": 1.175, "eva_mult": 1.06, "fear_mult": 1.045},  # 70% of SURGE (+17.5% SPD)  # 30% of DREAD (+6% Eva)  # 30% of DREAD (+4.5% Fear)
	"NIGHTLEECH": {"eva_mult": 1.14, "fear_mult": 1.105, "lifesteal_mult": 1.06},  # 70% of DREAD (+14% Eva)  # 70% of DREAD (+10.5% Fear)  # 30% of LEECH (+6% Lifesteal)
	"RAVENOUS": {"lifesteal_mult": 1.14, "atk_mult": 1.075}  # 70% of LEECH (+14% Lifesteal)  # 30% of SAVAGE (+7.5% ATK)
}
