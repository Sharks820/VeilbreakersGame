...
# Audio tab
@onready
var master_slider: HSlider = $Panel/MarginContainer/VBoxContainer/TabContainer/Audio/VBoxContainer/MasterVolume/HSlider
@onready
var music_slider: HSlider = $Panel/MarginContainer/VBoxContainer/TabContainer/Audio/VBoxContainer/MusicVolume/HSlider
@onready
var sfx_slider: HSlider = $Panel/MarginContainer/VBoxContainer/TabContainer/Audio/VBoxContainer/SFXVolume/HSlider
@onready
var voice_slider: HSlider = $Panel/MarginContainer/VBoxContainer/TabContainer/Audio/VBoxContainer/VoiceVolume/HSlider
@onready
var mute_unfocused_check: CheckButton = $Panel/MarginContainer/VBoxContainer/TabContainer/Audio/VBoxContainer/MuteUnfocused/CheckButton

# Display tab
@onready
var fullscreen_check: CheckButton = $Panel/MarginContainer/VBoxContainer/TabContainer/Display/VBoxContainer/Fullscreen/CheckButton
@onready
var vsync_check: CheckButton = $Panel/MarginContainer/VBoxContainer/TabContainer/Display/VBoxContainer/VSync/CheckButton
@onready
var resolution_option: OptionButton = $Panel/MarginContainer/VBoxContainer/TabContainer/Display/VBoxContainer/Resolution/OptionButton
@onready
var brightness_slider: HSlider = $Panel/MarginContainer/VBoxContainer/TabContainer/Display/VBoxContainer/Brightness/HSlider

# Gameplay tab
@onready
var text_speed_slider: HSlider = $Panel/MarginContainer/VBoxContainer/TabContainer/Gameplay/VBoxContainer/TextSpeed/HSlider
@onready
var battle_anims_check: CheckButton = $Panel/MarginContainer/VBoxContainer/TabContainer/Gameplay/VBoxContainer/BattleAnimations/CheckButton
@onready
var damage_numbers_check: CheckButton = $Panel/MarginContainer/VBoxContainer/TabContainer/Gameplay/VBoxContainer/DamageNumbers/CheckButton
@onready
var battle_log_check: CheckButton = $Panel/MarginContainer/VBoxContainer/TabContainer/Gameplay/VBoxContainer/BattleLog/CheckButton
@onready
var autosave_check: CheckButton = $Panel/MarginContainer/VBoxContainer/TabContainer/Gameplay/VBoxContainer/AutoSave/CheckButton

# Accessibility tab
@onready
var screen_shake_check: CheckButton = $Panel/MarginContainer/VBoxContainer/TabContainer/Accessibility/VBoxContainer/ScreenShake/CheckButton
@onready
var flash_effects_check: CheckButton = $Panel/MarginContainer/VBoxContainer/TabContainer/Accessibility/VBoxContainer/FlashEffects/CheckButton
@onready
var reduce_motion_check: CheckButton = $Panel/MarginContainer/VBoxContainer/TabContainer/Accessibility/VBoxContainer/ReduceMotion/CheckButton
@onready
var large_text_check: CheckButton = $Panel/MarginContainer/VBoxContainer/TabContainer/Accessibility/VBoxContainer/LargeText/CheckButton
...
func open() -> void:
	...
	panel_tween.tween_property(panel, "scale", Vector2.ONE, 0.3).set_ease(Tween.EASE_OUT).set_trans(
		Tween.TRANS_BACK
	)
...
func _exit_tree() -> void:
	...
	if (
		mute_unfocused_check
		and mute_unfocused_check.toggled.is_connected(_on_mute_unfocused_toggled)
	):
	...
	if (
		...
		and damage_numbers_check.toggled.is_connected(_on_damage_numbers_toggled)
	):
